...
func run() error {
	app, err := apps.NewAgentApp(
		...
		apps.WithAgentHeader(flagHeader),
		apps.WithAgentKey(flagKey),
		...
		apps.WithAgentCryptoKey(flagCryptoKey),
