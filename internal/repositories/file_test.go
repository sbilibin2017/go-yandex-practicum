...
func TestMetricFileSaveRepository_Save(t *testing.T) {
	...
	repo := NewMetricFileSaveRepository(WithFilePath(tmpFile))
...
func TestMetricFileGetRepository_Get(t *testing.T) {
	...
	repo := NewMetricFileGetRepository(WithFilePath(tmpFile))
...
func TestMetricFileListRepository_List(t *testing.T) {
	...
	repo := NewMetricFileListRepository(WithFilePath(tmpFile))
