...
// Source: /home/sergey/Go/go-yandex-practicum/internal/handlers/metric_update.go
...
func (m *MockMetricUpdater) Updates(ctx context.Context, metrics []*types.Metrics) ([]*types.Metrics, error) {
	m.ctrl.T.Helper()
