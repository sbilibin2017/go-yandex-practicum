...
type AgentWorkerOption func(*AgentWorkerConfig)

// NewAgentWorkerConfig creates a new AgentWorkerConfig applying given options.
func NewAgentWorkerConfig(opts ...AgentWorkerOption) *AgentWorkerConfig {
...
func WithPollInterval(interval int) AgentWorkerOption {
	return func(cfg *AgentWorkerConfig) {
